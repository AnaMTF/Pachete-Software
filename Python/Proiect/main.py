...
agregat_df['Raport Pret/Rating'] = agregat_df['pret_final'] / agregat_df['rating']

print(agregat_df)

produs_max_raport = agregat_df.loc[agregat_df['Raport Pret/Rating'].idxmax()]

# Afișarea produsului cu cel mai mare raport
print("Produsul cu cel mai mare raport Pret/Rating:")
print(produs_max_raport)